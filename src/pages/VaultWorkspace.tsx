    ...
    <div className="animate-sketch-in h-[calc(100vh-3rem)]">
      ...
      <div className="flex gap-4 h-[calc(100%-3.5rem)]">
        ...
        <div className="flex-1 flex flex-col">
          <div className={`sketchy-border-alt bg-card flex-1 relative ${selectedResource ? 'overflow-hidden' : 'flex items-center justify-center'}`}>
            ...
            {selectedResource && (() => {
              const att = attachments?.find((a) => a.id === selectedResource);
              return att ? (
                <FileViewer
                  key={att.id}
